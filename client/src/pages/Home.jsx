  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between border-b border-neutral-300 px-2 mb-2 rounded-md">
        <h1 className="text-5xl my-6 text-sky-600 font-extrabold tracking-wide">Books List</h1>
        <Link to="/book/create">
      ...
      {loading ? (
        ...
        <table className="w-full border-separate border-spacing-2">
          <thead>
            <tr className="text-white bg-gradient-to-r from-sky-500 to-sky-800 rounded-xl">
